...
<div id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/internal/write" method="post">
			...
			<div class="mb-3">
			    ...
			    <select name="category" class="form-select">
			        ...
			        <c:if test="${loginUser.user_access == 1 || loginUser.user_access == 2">
            ...
            <div class="d-flex gap-2 justify-content-end">
                <a href="${pageContext.request.contextPath}/internal/list" class="btn btn-secondary">
