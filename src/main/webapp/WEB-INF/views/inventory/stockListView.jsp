    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <main class="content p-4">
                <h4 class="fw-bold mb-4">월별 재고 조회</h4>

                <!-- 1. 재고 현황 요약 바 -->
                <div class="card shadow-sm mb-3 border-0 stock-summary-card">
                    <div class="card-body py-3">
                        <div class="row align-items-center">
                            <div class="col-md-3 border-end stock-summary-item">
                                <div class="d-flex align-items-center justify-content-center">
                                    <span class="stock-summary-label me-3">재고 현황</span>
                                    <select name="itemType" form="stockSearchForm" class="form-select form-select-sm w-auto bg-light border-0">
                            ...
                            <div class="col-md-3 border-end stock-summary-item">
							    <div class="d-flex align-items-center justify-content-center">
							        <span class="stock-summary-label me-3">재고 구분</span>
							        <select name="closingType"
							                form="stockSearchForm"
							                class="form-select form-select-sm w-auto bg-light border-0">
							            <option value="1" ${param.closingType == '1' || empty param.closingType ? 'selected' : ''}>기말재고</option>
							            <option value="0" ${param.closingType == '0' ? 'selected' : ''}>기초재고</option>
							        </select>
							    </div>
							</div>
                            ...
                            <div class="col-md-3 border-end stock-summary-item">
                                <div class="d-flex align-items-center justify-content-center text-center">
                                    ...
                                    <input type="month" name="searchYm" form="stockSearchForm" class="form-control form-control-sm w-auto" value="${searchYmValue}">
                                </div>
                            </div>
                ...
                <div class="card shadow-sm mb-4 border-0 stock-filter-box">
                    <div class="card-body">
                        <form id="stockSearchForm" action="${pageContext.request.contextPath}/inventory/stockListView" method="get">
                            <div class="row g-3">
                                <div class="col-md-5">
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text bg-white border-end-0"><i class="bi bi-search"></i></span>
                                        <input type="text" name="searchKeyword" class="form-control border-start-0" 
                                               placeholder="제품명 또는 제품 코드로 검색..." value="${param.searchKeyword}">
                                    </div>
                                </div>
                        ...
                        <table class="table table-hover align-middle mb-0 text-center stock-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>제품명</th>
                                    <th>카테고리</th>
                                    <th>${param.closingType == '0' ? '기초재고' : '기말재고'}</th>
                                    <th>적정재고</th>
                                    <th>적정재고상태</th>
                                    <th>최근변동일</th>
                                </tr>
                                    ...
                                    <c:when test="${not empty stockList}">
                                        <c:forEach items="${stockList}" var="stock" varStatus="status">
                                            <tr>
                                                ...
                                                <td><span class="badge bg-light text-dark border">${stock.category_name}</span></td>
				        ...
				        <ul class="pagination pagination-sm justify-content-center">
				            <c:forEach begin="${page.startPage}" end="${page.endPage}" var="pageNo">
				                <li class="page-item ${page.currentPage == pageNo ? 'active' : ''}">
				                    <c:url var="pageUrl" value="/inventory/stockListView">
				                        <c:param name="pageNum" value="${pageNo}" />
				                        <c:param name="itemType" value="${param.itemType}" />
				                        <c:param name="closingType" value="${param.closingType}" />
